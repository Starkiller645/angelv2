...
submissionwidget::SubmissionWidget::SubmissionWidget(std::string title,
  ...
  this->submission_icon_pixmap = this->submission_icon_pixmap.scaledToWidth(48, Qt::SmoothTransformation);
  ...
  this->main_layout->addWidget(this->submission_icon);
  ...
  this->submission_title->setStyleSheet("font-size: 32px; font-weight: bold; color: #fcfcfc;");
  ...
  this->submission_icon->setMaximumWidth(60);
